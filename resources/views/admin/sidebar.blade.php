        ...
        <div class="profile-desc">
          <div class="profile-pic">
            <div class="count-indicator">
              <img class="img-xs rounded-circle " src="{{ asset('admin/assets/images/faces/face8.jpg') }}" alt="">
      ...
      <li class="nav-item menu-items">
        ...
        <div class="collapse" id="ui-basic">
          <ul class="nav flex-column sub-menu">
            <li class="nav-item">
                <a class="nav-link" href=" {{route('view_product') }}">Add New Product</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href=" {{ route('show_product') }}">Show All Product</a>
            </li>
          </ul>
        </div>
      </li>
